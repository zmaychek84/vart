...
class DpuControllerXrtXvDpu : public xir::DpuController {
 public:
  DpuControllerXrtXvDpu(std::unique_ptr<xir::XrtCu>&& xrt_cu);
  virtual ~DpuControllerXrtXvDpu();
  DpuControllerXrtXvDpu(const DpuControllerXrtXvDpu& other) = delete;
  DpuControllerXrtXvDpu& operator=(const DpuControllerXrtXvDpu& rhs) = delete;

...
static traceClass dpu_controller("dpu-controller",
                                 {"event_state", "device_core_idx",
                                  "hwconuter"});
static traceClass dpu_runner("dpu-runner",
                             {"subgraph", "batch", "workload", "depth"});
static traceClass cpu_task("cpu-task", {"subgraph", "depth", "event_state"});
static traceClass user_task("user-task", {"event_state", "event_name", "info"});

...
class Conv : public InstBase {
 ...
 private:
  ...
  std::vector<int32_t> mt_addr_in_;
  std::vector<int32_t> h_num_;
  std::vector<int32_t> mt_addr_out_;
  std::vector<int32_t> in_h_num_list;
  std::vector<int32_t> out_h_num_list;
  ...
  vector<DPU_DATA_TYPE> layer_param_data_;  // 64
...
template <>
void Conv<DPUVersion::XV2DPU>::debug_output_tick(string prefix);
...
template <>
void Conv<DPUVersion::XV3DPU>::debug_output_tick(string prefix);

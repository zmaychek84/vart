...
class ElewInit : public InstBase {
 public:
 ...
 public:
  ...
  static int get_jump_bank(int i);
  static int get_share_pp(int i);
  static int get_macc_dim(int i);
 ...
 private:
  ...
  static deque<int> jump_bank_;
  static deque<int> share_pp_;
  static deque<int> macc_dim_;
